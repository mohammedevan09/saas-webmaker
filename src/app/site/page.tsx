...
export default async function Home() {
  const prices = await stripe.prices.list({
    product: process.env.NEXT_SAAS_PRODUCT_ID,
    active: true,
  })
  ...
  return (
    <>
      <section className="h-full w-full md:pt-[25rem] mt-[-70px] relative flex items-center justify-center flex-col ">
        {/* grid */}
              ...
              <CardFooter className="flex flex-col items-start gap-4">
                ...
                <Link
                  ...
                  className={clsx(
                    ...
                    {
                      '!bg-muted-foreground': card.nickname !== 'Ultimate Plan',
                    }
                  )}
                >
                  Get Started
